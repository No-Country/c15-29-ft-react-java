    ...
    <div>
      <div class="bg-white">
        <section class="bg-white dark:bg-gray-900 h-screen flex items-center justify-center">
          <div class="grid max-w-screen-xl grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="text-center lg:text-left">
              <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-indigo-700 dark:text-white mb-4">
                <span class="text-purple-500">Welcome</span> to Paw Finders
              </h1>
              <p class="text-gray-700 dark:text-gray-400 mb-8">
                ...
                perfect furry companion. Every paw has a story, and here, you'll
                discover the joy of giving a loving home to those who need it
                most. Join us in making a difference, one adoption at a time. 🐾
                #AdoptDontShop
              </p>
              <div class="space-y-4">
                <Link href="/adopt">
                  <button class="bg-purple-500 hover:bg-purple-600 text-white font-bold py-2 px-4 rounded-full inline-flex items-center transition-all duration-300 shadow-md">
                    <img
      ...
      <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
        <div className="mb-8">
          ...
          <p className="mt-4 text-lg">
            ...
            journey with this project began with a shared commitment to improve
            the prospects and well-being of pets.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="mt-4 text-lg">
            At{" "}
            <span className="font-bold text-yellow-700">Paw Finders</span>, we
          ...
          <p className="mt-4 text-lg">
            ...
            awareness about the joys of welcoming a furry friend into your life.
            At the heart of our mission is the belief that every pet deserves a
            second chance and a forever home. Join us in building a community
            that celebrates compassion, responsibility, and the unbreakable bond
        ...
        <div>
          ...
          <p className="mt-4 text-lg">
            ...
            meaningful connections between adopters and pets, contributing to
            the reduction of shelter populations and fostering stronger, more
          ...
          <p className="mt-4 text-lg">
            ...
            tirelessly working towards a future where adoption is the first
            choice for those seeking the loyal companionship of a new furry
            friend.
          </p>
        </div>
      </div>
      ...
      <section class="bg-gray-50 dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
          <figure class="max-w-screen-md mx-auto">
            ...
            <figcaption class="flex items-center justify-center mt-6 space-x-3"></figcaption>
          </figure>
        </div>
      </section>
    </div>
