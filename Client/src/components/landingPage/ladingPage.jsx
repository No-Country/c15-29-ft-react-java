...
<section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white"> <span class="text-purple-500"> Welcome</span> <br/>to Paw Finders</h1>
                <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400"> adopt your pet with paw finders,
                    we support the adoption of pets <a href="https://tailwindcss.com" class="hover:underline"></a> and based on the components from the </p>
                ...
                <img src="https://svgsilh.com/svg_v2/1084899.svg" alt=""  class="fill-current w-4 h-4 mr-2"/>
                    <span class="text-purple-500">ADOPT</span>
                </button>
                ...
                <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
                    ...
                    <span class="text-purple-500">GIVE UP FOR ADOPTION</span>
                 </button>

                </div>
            </div>
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex bg-gradient-to-t	">
                <img src="https://svgsilh.com/svg_v2/1084899.svg" class="bg-gradient-to-t	" alt="hero image"/>
            </div>                
        </div>
    </section>
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">What does paw finders consist of?</h2>
                    <p class="mb-8 font-light lg:text-xl">paw finders is a website that seeks to locate pets around the world to a suitable home</p>
                    ...
                    <ul role="list" class="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">help a street animal</span>
                        </li>
                        <li class="flex space-x-3">
                            
                            <svg class="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">help an abused animal</span>
                        </li>
                        <li class="flex space-x-3">
                            
                            <svg class="flex-shrink-0 w-5 h-5 text-purple-500 dark:text-purple-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">find a home for an animal</span>
                        </li>
                    <button class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
                            <img src="https://svgsilh.com/svg_v2/1084899.svg" alt=""  class="fill-current w-4 h-4 mr-2"/>
                             <span>adopt</span>
                    ...
                    <p class="mb-8 font-light lg:text-xl">Lorem ipsum dolor sit ame</p>

                </div>
                <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="https://i.pinimg.com/originals/cc/85/bc/cc85bc7f3af17bd4e7cfda5660e5d14f.gif" alt="dashboard feature image"/>
            </div>
            
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="https://usagif.com/wp-content/uploads/gify/dancing-cat-33-title.gif" alt="feature image 2"/>
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
            ...
            <div class="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                ...
                <div>
                <img src="https://svgsilh.com/svg_v2/1084899.svg" alt=""  class="w-10 h-10 mb-2 text-purple-600 md:w-12 md:h-12 dark:text-purple-500" fill="currentColor" />
